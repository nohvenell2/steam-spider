...
def get_database_url(
    ...
    Example:
        ...
        >>> print(url)
        postgresql://steam_user:steam_password@localhost:5432/steam_games
    """
...
def create_db_engine(database_url: str = None, echo: bool = False):
    ...
    Example:
        ...
        >>> print(engine)
        Engine(postgresql://steam_user:***@localhost:5432/steam_games)
    """
...
def get_session_context() -> Generator[Session, None, None]:
    ...
    Example:
        ...
        ...     game = session.query(BasicInfo).filter_by(game_id=1091500).first()
        ...     print(game.title)
    """
    session = get_session()
    try:
